...
export declare const DEFAULT_NAMESPACE = "stream-video";
...
export declare class StreamI18n {
    ...
    init: () => Promise<this>;
    changeLanguage: (language?: TranslationLanguage, onChange?: ((language: TranslationLanguage) => void) | undefined) => Promise<void>;
